...
from utils import obtener_practicante, verificar_entrada, obtener_estado_asistencia, canal_permitido, manejar_salida_anticipada
...
class Asistencia(commands.GroupCog, name="asistencia"):
    ...
    async def salida(self, interaction: discord.Interaction):
        ...
        if hora_actual < time(14, 0):
            ...
            modal = manejar_salida_anticipada(hora_actual, asistencia, nombre_usuario)
